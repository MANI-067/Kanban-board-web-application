...
export class ProjectComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.taskList.value.push(this.project.updateProject)
    }
        ...
        if(this.project.editProject){
          ...
          response => {
            ...
            for (let i = 0; i < this.members.value.length; i++) {
              ...
              this.http.get(`http://localhost:6677/api/v1/user/updateProject/${this.members.value[i]}/${project.name}`).subscribe(
        ...
        this.project.editProjectData(this.projectDetails.name, project).subscribe(
          response => {
            ...
            for (let i = 0; i < this.tempArrayForEdit.length; i++) {
              this.http.get(`http://localhost:6677/api/v1/user/updateProject/${this.tempArrayForEdit[i]}/${project.name}`).subscribe(
                response => {
